...
class Quote: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        var curQuote = listOfQuotes.randomElement()!
    ...
    func makeQuoteList() {
        listOfQuotes.append("quote1")
        listOfQuotes.append("quote2")
        listOfQuotes.append("quote3")
        listOfQuotes.append("quote4")
        listOfQuotes.append("quote5")
    }
